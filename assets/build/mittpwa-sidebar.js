(() => {
  ...
  const r = d,
    u = function (e) {
      ...
      const [c, l] = (0, i.useState)(""),
        s = (e) => {
          console.log("Selected topic:", e), l(e);
        };
      return (0, i.createElement)(
        ...
        (0, i.createElement)(
          "form",
          {
            ...
            method: "post",
            onSubmit: (e) => {
              s(e.target.value), e.preventDefault();
              const t = new FormData(e.target);
              t.append("topic", c);
              const a = document.getElementById("post_ID").value;
              console.log("postId", a);
              const n = document.getElementById("page_ID").value;
              console.log("pageId", n);
              let i = a || n;
              console.log("kindOfPage", i),
                wp
                  .apiFetch({
                    path: `/wp/v2/${i}/${a}?_fields=title,better_featured_image.source_url`,
                  })
                  .then((e) => {
                    console.log(e),
          ...
          (0, i.createElement)(n.SelectControl, {
            label: "Topic",
            value: c,
            options: [
    ...
    p = (0, l.withSelect)((e) => {
      ...
      return (0,
      i.createElement)(i.Fragment, null, (0, i.createElement)(a.PluginSidebarMoreMenuItem, { target: "mittpwa-sidebar" }, (0, c.__)("Push Messaging", "textdomain")), (0, i.createElement)(a.PluginSidebar, { name: "mittpwa-sidebar", title: (0, c.__)("Push Messaging", "textdomain") }, (0, i.createElement)(n.PanelBody, { title: (0, c.__)("Push Messaging", "textdomain"), initialOpen: !0 }, (0, i.createElement)(u, { ...e }))));
    });
