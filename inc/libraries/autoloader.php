 ...
 *
 * The argument should be in the form: MITTPWAWP\Namespace. The
...
spl_autoload_register(function ($class_name) {
    ...
    if (false === strpos($class_name, 'MITTPWAWP')) {
        return;
    }

    // Exclude the Firebase SDK from autoloading
    if ($class_name == 'MITTPWAWP\Serviceworker\FirebaseSDK') {
        return;
    }
